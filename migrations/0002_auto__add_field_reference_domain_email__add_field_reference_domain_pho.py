...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reference_Domain.email'
        db.add_column(u'django_reference_data_reference_domain', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Reference_Domain.phone'
        db.add_column(u'django_reference_data_reference_domain', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Reference_Domain.label'
        db.add_column(u'django_reference_data_reference_domain', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reference_Domain.email'
        db.delete_column(u'django_reference_data_reference_domain', 'email')

        # Deleting field 'Reference_Domain.phone'
        db.delete_column(u'django_reference_data_reference_domain', 'phone')

        # Deleting field 'Reference_Domain.label'
        db.delete_column(u'django_reference_data_reference_domain', 'label')
