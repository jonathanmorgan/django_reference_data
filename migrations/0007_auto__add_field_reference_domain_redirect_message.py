...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reference_Domain.redirect_message'
        db.add_column(u'django_reference_data_reference_domain', 'redirect_message',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reference_Domain.redirect_message'
        db.delete_column(u'django_reference_data_reference_domain', 'redirect_message')
