    ...
    for current_child in tbody_children_bs:
        ...
        if ( is_comment == True ):
            ...
            if ( COMMENT_STATE_CONTAINS in current_child ):
                ...
                station_tr_children_bs = current_child.children
                ...
                for current_td in station_tr_children_bs:
                    ...
                    # 1 - city name
                    # 3 - call sign, address, telephone (separated by <br />
                    # 5 - URL and/or email (href attribute contains "mailto").
                    if ( station_td_counter == 1 ):
                    
                        # city name - get text.
                        station_city = current_td.get_text()
                        ...
                        for current_font_bs in inner_font_list:
                            ...
                            # look for bold tag.
                            bold_bs = current_font_bs.find( "b" )
                            if ( ( bold_bs ) and ( bold_bs != None ) ):
                                ...
                                if ( ( city_state_zip_string ) and ( city_state_zip_string != "" ) ):
                                    ...
                                    station_zip_code = city_state_zip_item_list.pop()
                                    ...
                                    station_state = city_state_zip_item_list.pop()
                        ...
                        for current_anchor_bs in anchor_list_bs:
                            ...
                            href_value = current_sibling[ 'href' ]
                ...
                if ( ( station_url ) and ( station_url != None ) and ( station_url != "" ) ):
                    ...
                    station_domain_name = django_reference_data.models.Reference_Domain.parse_URL( nbc_url, django_reference_data.models.Reference_Domain.URL_PARSE_RETURN_DOMAIN )
                    station_domain_path = django_reference_data.models.Reference_Domain.parse_URL( nbc_url, django_reference_data.models.Reference_Domain.URL_PARSE_RETURN_PATH )
                    ...
                    print( str( current_domain_instance ) )
